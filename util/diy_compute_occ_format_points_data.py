...
def process_id(id):
    occ_save_dir = f"/data_new2/sz_zzz/Data/Teeth/RD_2/crown_occ"
    pcd_save_dir = f"/data_new2/sz_zzz/Data/Teeth/RD_2/crown_4_pointcloud"
